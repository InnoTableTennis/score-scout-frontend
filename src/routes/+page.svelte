...
>
	<Button
		variant="ghost"
		class="z-20 absolute top-10 left-10 m-auto text-lg gap-2 flex items-center justify-center"
	>
		<LogOut class="w-6 h-6" />
		Logout
	</Button>
	<Button
		class="z-20 absolute bottom-8 right-8 m-auto text-base leading-5 gap-2.5 flex items-center justify-center"
	>
		<Plus class="w-5 h-5" />
		Create tournament
	</Button>
